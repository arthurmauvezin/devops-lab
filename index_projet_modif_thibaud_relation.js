...
/*app.get('/animals/:id/cages',function(req,res){
	var query="SELECT * FROM animals INNER JOIN cages ON animals.id_cage=cages.id"
...
// Relation cages in animals with animals ID
app.get('/animals/:id/cages',function(req,res){
	var query="SELECT * FROM animals INNER JOIN cages ON animals.id_cage=cages.id"
...
/*//Route relation
app.get('/animals/:id/cages/:id',function(req,res){
	var query="SELECT * FROM animals INNER JOIN cages ON animals.id_cage=cages.id"
...
app.get('/animals/:id/food',function(req,res){
	var query="SELECT * FROM animals INNER JOIN food ON animals.id=food.id_animal"
...
//
app.get('/animals/:id/food/:id',function(req,res){
	var query="SELECT * FROM animals INNER JOIN food ON animals.id=food.id_animal"
...
app.get('cages/animals', function(req,res) {
	...
	var query="SELECT * FROM cages INNER JOIN animals on cages.name=animals.name";
...
//
app.get('cages/:id/animals/:id', function(req,res) {
	var query="SELECT * FROM cages INNER JOIN animals on cages.name=animals.name";
...
app.get('/food/:id/animals', function(req, res) {
	...
	var query = "SELECT * FROM food INNER JOIN animals ON food.id_animal=animals.id"
...
//
app.get('/food/:id/animals/:id', function(req, res) {
